...
# Genera representaciones vectoriales (embeddings) para cada título en el DataFrame 'df'
# utilizando el modelo pre-entrenado.
embeddings = model.encode(df['Title'],batch_size=64,show_progress_bar=True)

# Agrega una nueva columna 'embeddings' al DataFrame 'df' y almacena 
# las representaciones vectoriales generadas en ella.
